...
function IssueDetails() {
  ...
  const fetchIssue = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/issues/${id}`, {
  ...
  const handleUpvote = async () => {
    try {
      await axios.post(`${import.meta.env.VITE_BACKEND_URL}/issues/${id}/upvote`, {}, {
        withCredentials: true
      });
      fetchIssue();
    } catch (error) {
  ...
  const handleComment = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`${import.meta.env.VITE_BACKEND_URL}/issues/${id}/comments`, {
        text: comment,
      }, {
        withCredentials: true
      });
