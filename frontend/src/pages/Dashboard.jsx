...
function Dashboard() {
  ...
  const fetchIssues = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/issues?status=${selectedStatus}`, {
  ...
  const handleStatusChange = async (issueId, newStatus) => {
    try {
      await axios.put(`${import.meta.env.VITE_BACKEND_URL}/issues/${issueId}`, {
        status: newStatus,
